...
\begin{document}
	...
	\end{proof}
 	...
 	\begin{theorem}
 		Falls es eine $\mathcal{L}$-Theorie $T^*$ gibt, so dass $\operatorname{Mod}(T^*) = \{ \mathfrak{M} \models T_\forall \mid \mathfrak{M} \text{ $T$-existentiell abgeschlossen} \}$. Dann ist $T^*$ Modellbegleiter von $T$.
 	\end{theorem}
